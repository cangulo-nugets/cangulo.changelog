...
using cangulo.changelog.domain.markdown;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;

namespace cangulo.changelog.domain.Builders.ConventionalCommits
{
    public class ChangesAreaBuilderForConventionalCommits : IChangesListAreaBuilder
    {
        ...
        {
            var types = _changelogSettings.ConventionCommitsSettings.Types;
